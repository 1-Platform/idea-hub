context( 'Test for Idea Hub', () => {
    ...
    it( 'Test for post a new idea', () => {
        ...
        cy.wait( 5000 );
        cy.get( '.pf-c-card__body' ).first({force:true}).should( 'contain.text', 'e2e test automation' );
    } );
    ...
    it( 'Test for archive an idea', () => {
        ...
        cy.contains( 'Successfully archived',{timeout:60000} ).should( 'be.visible' );
        ...
        cy.contains( 'Successfully unarchived',{timeout:60000} ).should( 'be.visible' );
    } )
